...
//			extentReporterTest.log(LogStatus.INFO, "Test Passed");
	...
	public static void passExtentReport(String description, ExtentTest extentedReport) {
	...
	public static void passExtentReportWithScreenShot(String description, ExtentTest extentedReport, WebDriver driver) {
