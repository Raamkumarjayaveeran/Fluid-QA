package utils.SECFramework.testlink;

/**
 * The constants used by the dbfacade implementation of the TestLink API. The method names and execution parameter constants can be found in this file.
 * 
 */
public interface TestLinkAPIConst {
	...
	/*
	 * Readability constants. TestLink can change any of these variables at their discretion but this is what they seem to currently use for their API values.
	 */
